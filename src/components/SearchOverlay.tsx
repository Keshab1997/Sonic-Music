...
export const SearchOverlay = ({ onClose }: SearchOverlayProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      <div ref={overlayRef} className="relative w-full max-w-2xl mx-auto mt-0 md:mt-16 h-full md:h-auto md:max-h-[80vh] glass-heavy border-0 md:border border-border md:rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        {/* Search Bar */}
